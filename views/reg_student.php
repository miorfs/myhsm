...
<head>
	...
	<script src="j-folder/js/student-script.js"></script>
			...
			<div class="divider-text gap-top-20 gap-bottom-45">
				...
				<div class="unit">
					<div class="input">
						...
						<input type="text" id="studentName" name="studentName" placeholder="Student Name" required="required">
					</div>
				</div>
				...
				<div class="j-row">
					...
					<div class="span6 unit">
						<div class="input">
							...
							<input type="text" id="studentPhoneNo" name="studentPhoneNo" placeholder="Phone No.">
						</div>
					</div>
				</div>
				<!-- end name email -->
				...
				<div class="unit">
					<div class="input">
						...
						<input type="email" id="studentEmail" name="studentEmail" placeholder="Email">
					</div>
				</div>
				...
				<div class="j-row">
					<div class="span6 unit">
						<div class="input">
							...
							<input type="email" id="parentEmail" name="parentEmail" placeholder="Email">
						</div>
					</div>
					<div class="span6 unit">
						<div class="input">
							...
							<input type="text" id="parentPhoneNo" name="parentPhoneNo" placeholder="Phone No.">
						</div>
					</div>
				</div>
				<!-- end name email -->
				...
				<div class="j-row">
					...
					<div class="span6 unit">
						<div class="input">
							<input type="text" placeholder="Year/Semester" name="year" id="year">
						</div>
					</div>
				</div>
				<!-- end name -->
				...
				<div class="unit">
					<label class="input select">
						<select name="gpa" id="gpa">
							<option value="" selected> GPA (Last Semester) </option>
